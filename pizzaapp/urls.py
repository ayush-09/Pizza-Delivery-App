...
from .views import acceptorder,declineorder,adminorders,userorders,placeorder,userlogout,userauthenticate,customerwelcomeview,userloginview,signupuser,homepageview,addpizza,deletepizza,adminloginview,adminhomepageview,authenticateadmin,logoutadmin
urlpatterns = [
